...
public class OAuth2AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients
            .inMemory()
            .withClient("4c73df0f-a991-46e2-ba3e-94ff55c3c487")
            .secret("c862442d26fdd5682306ba5b07dcf5f0b51074d578f3d001ee7229469d545cbb")  // password
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
		...
		endpoints.userDetailsService(userDetailsService) // refresh token 발급을 위해서는
															// UserDetailsService(AuthenticationManager authenticate()에서
															// 사용)필요
				.authorizationCodeServices(new JdbcAuthorizationCodeServices(dataSource)) // authorization code를 DB로 관리
																							// 코드 테이블의 authentication은
																							// blob데이터타입으로..
