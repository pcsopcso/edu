...
import com.daniel.todo.dao.TodoRepository;
...
public class DatabaseLoader implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Arrays.asList(new Todo(-1L, "daniel", "메일", "2019-09-27 14:30:00", false),
				new Todo(-1L, "park", "결재", "2019-09-27 14:30:00", false),
				new Todo(-1L, "daniel", "일정", "2019-09-27 14:30:00", false)).forEach(todo -> todoRepository.save(todo));
